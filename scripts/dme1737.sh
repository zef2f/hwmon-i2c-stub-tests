...
permissions_dme1737=(
	"-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--"
	"-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--"
	"-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--"
	"-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--"
	"-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--"
	"-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--"
	"-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--"
	"-r--r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-rw-r--r--"
	"-rw-r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--"
	"-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--"
	"-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--"
	"-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-rw-r--r--"
...
permissions_dme1737_wp=(
	...
	"-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-rw-r--r--" "-rw-r--r--" "-r--r--r--" "-rw-r--r--" "-r--r--r--"
	"-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--" "-r--r--r--"
	"-r--r--r--" "-r--r--r--"
)
...
runtest()
{
    ...
    for t in $(seq 1 3)
    do
	check_range -b ${basedir} -d 500 -r -q -s 25000 temp${t}_min
	rv=$(($? + ${rv}))
	check_range -b ${basedir} -d 500 -r -q -s 25000 temp${t}_max
	rv=$(($? + ${rv}))
	if [ $wp -eq 0 -a -e ${basedir}/temp1_offset ]
	then
	    check_range -b ${basedir} -d 500 -r -q -s 25000 temp${t}_offset
	    rv=$(($? + ${rv}))
	fi
    done
    ...
    for i in $(seq 0 6)
    do
	check_range -b ${basedir} -d 31 -r -q -s 512 in${i}_min
	rv=$(($? + ${rv}))
	check_range -b ${basedir} -d 31 -r -q -s 512 in${i}_max
	rv=$(($? + ${rv}))
    done

    for f in $(seq 1 4)
    do
	check_range -b ${basedir} -l 0 -u 100000 -n -d 1500 -r -q -s 10000 fan${f}_min
	rv=$(($? + ${rv}))
	check_range -b ${basedir} -l 1 -u 2 -d 0 -r -q fan${f}_type
	rv=$(($? + ${rv}))
    done
	...
	for p in $(seq 1 3)
	do
	    check_range -b ${basedir} -l 0 -u 255 -n -d 0 -r -q -s 32 pwm${p}_auto_point1_pwm
	    rv=$(($? + ${rv}))
	    check_range -b ${basedir} -l 0 -u 2 -d 0 -r -q pwm${p}_enable
	    rv=$(($? + ${rv}))
	    check_range -b ${basedir} -l 0 -n -r -q -d 7500 -s 5000 pwm${p}_freq
	    rv=$(($? + ${rv}))
	    check_range -b ${basedir} -l 0 -n -r -q -s 32 pwm${p}_ramp_rate
	    rv=$(($? + ${rv}))
	    if [ -e ${basedir}/pwm${p}_auto_pwm_min ]
	    then
		check_range -b ${basedir} -l 0 -n -r -q -s 32 pwm${p}_auto_pwm_min
		rv=$(($? + ${rv}))
	    fi
	done
	...
	do
	    ...
	    then
		check_range -b ${basedir} -r -d 500 -q -s 2000 zone${z}_auto_point1_temp_hyst
		rv=$(($? + ${rv}))
	    fi
	    for t in $(seq 1 3)
	    do
		check_range -b ${basedir} -r -q -s 10000 zone${z}_auto_point${t}_temp
		rv=$(($? + ${rv}))
	    done
	done
    fi
    ...
    if [ -e ${basedir}/vrm ]
    then
	check_range -b ${basedir} -l 0 -u 255 -r -d 0 -q -s 32 vrm
	rv=$(($? + ${rv}))
    fi
